...
https://forex-track.streamlit.app/

## Features

- All major currencies
- Add trades in the app or manually in a .csv file
- Track forex portfolio valuation with live market data
...
```bash
git clone https://github.com/chahatmandviwala-alt/ForexTracker.git
```
...
Note: The local build of this application requires a personal Google OAuth configuration for using the 'Login with Google' option. Use the 'Local login' option or follow the steps below to create your own credentials and update the ./streamlit/secrets.example.toml file.
...
- FX Tracker (https://github.com/chahatmandviwala-alt/PortfolioTracker)
